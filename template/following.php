        ...
        <li class="list-group-item d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                <?php if (!empty($followed_info['profile_image']) && file_exists(UPLOAD_DIR . $followed_info['profile_image'])): ?>
                    <img src="<?php echo UPLOAD_DIR . htmlspecialchars($followed_info['profile_image']); ?>" alt="Immagine Profilo" class="avatar-rounded img-fluid me-3" style="width: 50px; height: 50px;">
                <?php else: ?>
