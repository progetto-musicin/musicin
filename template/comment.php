<article class="card card-body" id="comment-<?php echo $comment['id']; ?>">
    ...
    <p><small class="text-muted">Creato da: <a href="/profile.php?id=<?php echo $comment["user_id"] ?>"><?php echo htmlspecialchars($dbh->getUserInfo($comment['user_id'])['username']); ?></a> il: <?php echo htmlspecialchars(formatDatetime($comment['created_at'])); ?></small></p>
